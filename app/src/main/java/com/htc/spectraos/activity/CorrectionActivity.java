...
//                KeystoneUtils_726.writeGlobalSettings(getApplicationContext(), "zoom_value", 0);
    ...
    private void refreshStateValueUI() {
        if (check_lt != null && check_lb != null && check_rt != null
            ...
            if (check_lt.isChecked()) {
                ...
                if ((x + xy_OppositeTo[0]) >= KeystoneUtils_726.minH_size) {
                    right = false;
                }
                if (y <= KeystoneUtils_726.minY) {
                    top = false;
                }
                if ((y + xy_OppositeTo[1]) >= KeystoneUtils_726.minV_size) {
                    bottom = false;
                }
