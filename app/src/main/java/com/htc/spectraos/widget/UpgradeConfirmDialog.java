...
public class UpgradeConfirmDialog extends BaseDialog implements View.OnClickListener {
    ...
    public UpgradeConfirmDialog(Context context,String path) {
        super(context);
    ...
    public UpgradeConfirmDialog(Context context, boolean cancelable,
    ...
    public UpgradeConfirmDialog(Context context, int theme) {
        super(context, theme);
    ...
    private void initView(){
        ...
        upgradeCheckFailBinding.enter.setText(mContext.getString(R.string.enter));
        upgradeCheckFailBinding.msg.setText(mContext.getString(R.string.find_local_update_msg,path));
